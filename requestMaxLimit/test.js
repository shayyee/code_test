const RequestDecorator = require('./index.js')
...
for (let i = 0; i < 30; i++) {
  ...
  let request = requestInstance.request(i, Math.random() * 3000).then(result => console.log('result', result), error => console.log(error))
